...
const OrderManagement = () => {
  const orders = [
    { id: 'ORD-1001', customer: 'Raj Kumar', vendor: 'Fresh Groceries', amount: '₹850', status: 'Delivered', payment: 'Paid' },
    { id: 'ORD-1002', customer: 'Priya Sharma', vendor: 'Medi Pharma', amount: '₹420', status: 'Preparing', payment: 'Paid' },
    { id: 'ORD-1003', customer: 'Amit Patel', vendor: 'Food Palace', amount: '₹1,250', status: 'Placed', payment: 'Pending' },
    { id: 'ORD-1004', customer: 'Sneha Reddy', vendor: 'Meat Masters', amount: '₹680', status: 'Cancelled', payment: 'Refunded' },
    { id: 'ORD-1005', customer: 'Rahul Verma', vendor: 'Quick Mart', amount: '₹920', status: 'Out for Delivery', payment: 'Paid' },
  ];
  ...
  const orderStats = [
    ...
    { label: 'Cancelled', value: '53', color: 'bg-red-500' },
  ];
